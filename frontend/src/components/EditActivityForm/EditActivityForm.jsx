...
const ActivityForm = () => {
    ...
    let [startTime, setStartTime] = useState(
        currentTime.toISOString().slice(0, -5)
    );
    ...
    const [formHeader, buttonText, activityAction] = activity
        ? ["Manual Update", "Update Activity", activityActions.updateActivity]
        : ["Manual Entry", "Create", activityActions.newActivity];
    ...
    return (
        <div className="form-page">
            ...
            <form className="form-container">
                ...
                <div className="form-details-container">
                    <div className="sport-time-container">
                        <div className="form-detail-container">
                            <div className="form-detail-label-container">
                                <label className="form-detail-label">
                                    Sport
                                </label>
                            </div>
                    ...
                    <div className="form-detail-title-container">
                        <div className="form-detail-label-container">
                            <label className="form-detail-label">Title</label>
                        </div>
                ...
                <div className="action-button">
                    <button
                        ...
                        onClick={handleClick}
                        disabled={
                            hours + minutes + seconds === 0 || distance === 0
                        }
                    >
                        {buttonText}
                    </button>
            ...
            <div className="cancel-delete-buttons">
                <button className="cancel-edit-activity" onClick={cancelButton}>
                    Cancel
                </button>
                <div className="delete-button">{renderDelete()}</div>
            </div>
        </div>
    );
};
